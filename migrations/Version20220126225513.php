 ...
 */
final class Version20220126225513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_534E6880FEE30A60');
        $this->addSql('CREATE TEMPORARY TABLE __temp__work AS SELECT id, _order_id, order1_id, title FROM work');
        $this->addSql('DROP TABLE work');
        $this->addSql('CREATE TABLE work (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, _order_id INTEGER NOT NULL, order1_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_534E6880A35F2858 FOREIGN KEY (_order_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_534E6880FEE30A60 FOREIGN KEY (order1_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO work (id, _order_id, order1_id, title) SELECT id, _order_id, order1_id, title FROM __temp__work');
        $this->addSql('DROP TABLE __temp__work');
        $this->addSql('CREATE INDEX IDX_534E6880A35F2858 ON work (_order_id)');
        $this->addSql('CREATE INDEX IDX_534E6880FEE30A60 ON work (order1_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__work AS SELECT id, _order_id, order1_id, title FROM work');
        $this->addSql('DROP TABLE work');
        $this->addSql('CREATE TABLE work (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, _order_id INTEGER NOT NULL, order1_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO work (id, _order_id, order1_id, title) SELECT id, _order_id, order1_id, title FROM __temp__work');
        $this->addSql('DROP TABLE __temp__work');
        $this->addSql('CREATE INDEX IDX_534E6880A35F2858 ON work (_order_id)');
        $this->addSql('CREATE INDEX IDX_534E6880FEE30A60 ON work (order1_id)');
