 ...
 */
final class Version20220126224946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO work (id, _order_id, order1_id, title) SELECT id, _order_id, __order_id, title FROM __temp__work');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO work (id, _order_id, __order_id, title) SELECT id, _order_id, order1_id, title FROM __temp__work');
        $this->addSql('DROP TABLE __temp__work');
        $this->addSql('CREATE INDEX IDX_534E6880A35F2858 ON work (_order_id)');
