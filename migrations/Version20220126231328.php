 ...
 */
final class Version20220126231328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE work (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__work AS SELECT id, title FROM work');
        $this->addSql('DROP TABLE work');
        $this->addSql('CREATE TABLE work (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, _order_id INTEGER NOT NULL, order1_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO work (id, title) SELECT id, title FROM __temp__work');
        $this->addSql('DROP TABLE __temp__work');
