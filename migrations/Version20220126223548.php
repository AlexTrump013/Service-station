 ...
 */
final class Version20220126223548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, carinfo_id, client_id, master_id, _order_id FROM "order"');
        $this->addSql('DROP TABLE "order"');
        $this->addSql('CREATE TABLE "order" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, carinfo_id INTEGER NOT NULL, client_id INTEGER NOT NULL, master_id INTEGER NOT NULL, _order_id INTEGER NOT NULL, CONSTRAINT FK_F5299398BCD0CA89 FOREIGN KEY (carinfo_id) REFERENCES carinfo (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F529939819EB6921 FOREIGN KEY (client_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F529939813B3DB11 FOREIGN KEY (master_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F5299398A35F2858 FOREIGN KEY (_order_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO "order" (id, carinfo_id, client_id, master_id, _order_id) SELECT id, carinfo_id, client_id, master_id, _order_id FROM __temp__order');
        ...
        $this->addSql('CREATE INDEX IDX_F5299398A35F2858 ON "order" (_order_id)');
        $this->addSql('DROP INDEX IDX_534E6880A35F2858');
        $this->addSql('CREATE TEMPORARY TABLE __temp__work AS SELECT id, _order_id, title FROM work');
        $this->addSql('DROP TABLE work');
        $this->addSql('CREATE TABLE work (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, _order_id INTEGER NOT NULL, __order_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_534E6880A35F2858 FOREIGN KEY (_order_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_534E6880EEC38945 FOREIGN KEY (__order_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO work (id, _order_id, title) SELECT id, _order_id, title FROM __temp__work');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F5299398A35F2858');
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, carinfo_id, client_id, master_id, _order_id FROM "order"');
        $this->addSql('DROP TABLE "order"');
        $this->addSql('CREATE TABLE "order" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, carinfo_id INTEGER NOT NULL, client_id INTEGER NOT NULL, master_id INTEGER NOT NULL, _order_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO "order" (id, carinfo_id, client_id, master_id, _order_id) SELECT id, carinfo_id, client_id, master_id, _order_id FROM __temp__order');
        $this->addSql('DROP TABLE __temp__order');
        $this->addSql('DROP INDEX IDX_534E6880A35F2858');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__work AS SELECT id, _order_id, title FROM work');
        $this->addSql('DROP TABLE work');
        $this->addSql('CREATE TABLE work (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, _order_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO work (id, _order_id, title) SELECT id, _order_id, title FROM __temp__work');
        $this->addSql('DROP TABLE __temp__work');
        $this->addSql('CREATE INDEX IDX_534E6880A35F2858 ON work (_order_id)');
    }
