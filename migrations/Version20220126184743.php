 ...
 */
final class Version20220126184743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__job AS SELECT id, title, pricework FROM job');
        ...
        $this->addSql('INSERT INTO job (id, title, pricework) SELECT id, title, pricework FROM __temp__job');
        ...
        $this->addSql('CREATE TABLE "order" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, carinfo_id INTEGER NOT NULL, person_id INTEGER NOT NULL, CONSTRAINT FK_F5299398BCD0CA89 FOREIGN KEY (carinfo_id) REFERENCES carinfo (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_F5299398217BBB47 FOREIGN KEY (person_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__job AS SELECT id, title, pricework FROM job');
        $this->addSql('DROP TABLE job');
        $this->addSql('CREATE TABLE job (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, pricework INTEGER NOT NULL)');
        $this->addSql('INSERT INTO job (id, title, pricework) SELECT id, title, pricework FROM __temp__job');
        $this->addSql('DROP TABLE __temp__job');
        $this->addSql('DROP INDEX IDX_F5299398BCD0CA89');
        $this->addSql('DROP INDEX IDX_F5299398217BBB47');
        $this->addSql('CREATE TEMPORARY TABLE __temp__order AS SELECT id, carinfo_id FROM "order"');
        $this->addSql('DROP TABLE "order"');
