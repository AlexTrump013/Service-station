 ...
 */
final class Version20220126212911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE work (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, morder_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_534E6880A398C00C FOREIGN KEY (morder_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
