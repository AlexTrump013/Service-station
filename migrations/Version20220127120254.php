 ...
 */
final class Version20220127120254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__work AS SELECT id, workstatus_id, title FROM work');
        $this->addSql('DROP TABLE work');
        $this->addSql('CREATE TABLE work (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, workstatus_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_534E68809082CF81 FOREIGN KEY (workstatus_id) REFERENCES workstatus (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO work (id, workstatus_id, title) SELECT id, workstatus_id, title FROM __temp__work');
        $this->addSql('DROP TABLE __temp__work');
        $this->addSql('CREATE INDEX IDX_534E68809082CF81 ON work (workstatus_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_F529939819EB6921 ON "order" (client_id)');
        $this->addSql('CREATE INDEX IDX_F529939813B3DB11 ON "order" (master_id)');
        $this->addSql('DROP INDEX IDX_534E68809082CF81');
        $this->addSql('CREATE TEMPORARY TABLE __temp__work AS SELECT id, workstatus_id, title FROM work');
        $this->addSql('DROP TABLE work');
        $this->addSql('CREATE TABLE work (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, workstatus_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO work (id, workstatus_id, title) SELECT id, workstatus_id, title FROM __temp__work');
        $this->addSql('DROP TABLE __temp__work');
    }
}
