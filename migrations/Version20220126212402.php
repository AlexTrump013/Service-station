 ...
 */
final class Version20220126212402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carinfo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, brand VARCHAR(255) NOT NULL COLLATE BINARY, model VARCHAR(255) NOT NULL COLLATE BINARY, year INTEGER NOT NULL, vincode VARCHAR(255) NOT NULL COLLATE BINARY, numder VARCHAR(255) NOT NULL COLLATE BINARY)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__work AS SELECT id, title FROM work');
        $this->addSql('DROP TABLE work');
        $this->addSql('CREATE TABLE work (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, morder_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_534E6880A398C00C FOREIGN KEY (morder_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO work (id, title) SELECT id, title FROM __temp__work');
        $this->addSql('DROP TABLE __temp__work');
        $this->addSql('CREATE INDEX IDX_534E6880A398C00C ON work (morder_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE carinfo ADD COLUMN description CLOB DEFAULT NULL COLLATE BINARY');
        ...
        $this->addSql('DROP TABLE __temp__order');
        $this->addSql('CREATE INDEX IDX_F5299398BCD0CA89 ON "order" (carinfo_id)');
        $this->addSql('DROP INDEX IDX_534E6880A398C00C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__work AS SELECT id, title FROM work');
        $this->addSql('DROP TABLE work');
        $this->addSql('CREATE TABLE work (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO work (id, title) SELECT id, title FROM __temp__work');
        $this->addSql('DROP TABLE __temp__work');
    }
}
